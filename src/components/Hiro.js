        ...
        <div id="home" className="flex w-full h-screen flex-col md:flex-row gap-5 items-center justify-center text-white relative">
            ...
            <div className='md:w-3/6' data-aos="fade-right" data-aos-duration="1000" data-aos-offset="100" >
                <div className="flex flex-col w-full mt-8">
                    ...
                    <h1 className="text-2xl font-bold">Arjuna Arrasyid</h1>
                    <p class="text-xl font-bold text-gray-300">Full Stack Developer</p>
                    <p className="text-md font-light text-gray-400 ">I am a Full Stack Developer, Admin and Content Creator With a less than a year of experience.</p>
                </div>
